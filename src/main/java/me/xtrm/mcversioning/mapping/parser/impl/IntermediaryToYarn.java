...
public class IntermediaryToYarn implements IMappingParser {
    @Override
    public MappingData parseMappingData(MappingData mappingData, File mappingFile) throws IOException {
        return null;
    }
}
